<section class="relative z-20 -mb-34 py-20 px-6 lg:px-8">
    <div class="relative overflow-hidden rounded-4xl bg-yellow-600 border border-white/10 shadow-2xl">
        ...
        <div class="relative mx-auto max-w-5xl px-6 py-15 text-center">
            <h2 class="mt-6 text-3xl font-bold text-black sm:text-4xl font-serif leading-tight">
                "Kebaikan kecil secara istiqamah akan menghadirkan manfaat yang besar"
            </h2>
            <p class="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-900">
                Dukungan Anda membantu Yayasan Bina Salamah dalam menjalankan berbagai program yayasan dan
                membantu kehidupan bagi yatim dan dhuafa.
            </p>
            <!-- Impact Stats -->
            ...
            <div class="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a href="{{ url('/kegiatan') }}"
                   class="group flex items-center gap-3 rounded-full border border-white/20 px-8 py-4 font-semibold text-white transition-all duration-300 hover:border-white hover:bg-white/5">
