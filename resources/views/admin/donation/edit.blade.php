                ...
                <form action="{{ route('admin.donations.update', $donation->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    @method('PUT')
                        <div class="grid gap-6">
                            <div>
                                <label class="mb-2 block text-xs font-bold uppercase tracking-wider text-gray-500">Gambar Bukti Transfer</label>
                                    <div class="h-72 bg-gray-100 mb-4">
                                        <img
                                            src="{{ $donation->image ? asset('storage/donations/' . $donation->image) : 'https://via.placeholder.com/900x500?text=No+Image' }}"
                                            alt="{{ $donation->name }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="notes" value="{{ old('notes', $donation->notes) }}" class="p-3 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
