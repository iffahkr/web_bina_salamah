...
<head>
    ...
    <title>Donasi | {{ config('app.name') }}</title>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-8" x-data="{ copied: false }">
                ...
                <div class="mt-6 text-center flex flex-row items-center gap-2">
                    ...
                    <p class="text-sm text-slate-500 text-center">
                        Setelah melakukan transfer, harap lakukan konfirmasi melalui nomor di bawah ini.
                    </p>
                </div>
                <!-- WhatsApp Button -->
